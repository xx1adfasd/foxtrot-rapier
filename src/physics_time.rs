...
Aug 8, 2024:
bevy_avian/xpbd has a Physic struct so we can use a Time<Physic>,
but in rapier we need to on our own.

See the following link:

 https://github.com/dimforge/bevy_rapier/issues/440
 https://github.com/rlidwka/bevy-rapier-sim-time
 https://github.com/rlidwka/bevy-rapier-sim-time/pull/1
 https://github.com/aDecoy/bevy-rapier-sim-time/tree/master
*/
